...
Podsumowując, wybór algorytmu rekomendacyjnego w systemach VOD nie powinien opierać się wyłącznie na maksymalizacji metryki NDCG. Wyniki eksperymentu wskazują, że choć grafowe sieci neuronowe uzyskują najwyższą trafność, ich implementacja wiąże się ze znacznym kosztem obliczeniowym. Biorąc pod uwagę ograniczenia sprzętowe oraz wymóg niskiego opóźnienia w środowiskach produkcyjnych, zoptymalizowane metody oparte na faktoryzacji (BPR) lub architekturach hybrydowych (NeuMF) wciąż stanowią wysoce wydajną alternatywę.