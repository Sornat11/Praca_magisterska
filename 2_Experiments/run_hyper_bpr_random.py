...
if __name__ == '__main__':
    model_name = 'BPR_Random'
    config_file_list = ['2_Experiments/Configs/bpr.yaml']
    params_file = '2_Experiments/Hyperparams/bpr_random.hyper'
    output_file = f'3_Evaluation/Reports/hyper_results_bpr_random.result'
    ...
    print(f"Rozpoczynam optymalizację parametrów (Random Search) dla modelu: BPR")
    hp.run()
